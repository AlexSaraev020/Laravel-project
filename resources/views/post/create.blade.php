                ...
                <div class="p-6 bg-slate-900 border-2 border-slate-400 ">
                    <form method="POST" action="{{ route('post.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="flex bg-slate-700 items-center justify-center w-full">
                            <label for="file"
                                ...
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    <!-- Empty image tag to display the uploaded image -->
                        ...
                        <script>
                            ...
                            fileInput.addEventListener('change', function() {
                                ...
                                if (file) {
                                    ...
                                    // If no file selected, clear the preview image
                                    previewImage.src = '';
                                }
                            });
                        </script>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text"
                                class="text-white rounded-lg border-2 bg-slate-800 border-slate-400 p-2 w-full"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text"
                                class="text-white rounded-lg bg-slate-800 border-2 border-slate-400 p-2 w-full"
                                name="description" id="description" placeholder="Write a description" required>
                        </div>
                        ...
                        <div class="flex p-1">
                            <button role="submit"
                                class="mr-2 p-3 bg-slate-800 border-2 border-slate-400 text-white hover:bg-slate-400"
                                required>Submit</button>
                            <a href="{{ route('principal') }}"
                                class="mx-2 p-3 bg-slate-800 border-2 border-slate-400 text-white hover:bg-slate-400"
                                required>Cancel</a>
                        </div>
                    </form>
                </div>
